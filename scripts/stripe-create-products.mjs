...
const PACKS = [
  ...
  { id: 'scada-energy-operations',     name: 'SCADA & Energy Operations Starter Kit',       price: 149 },
  { id: 'manufacturing-line',          name: 'Manufacturing Line Operations Starter Kit',   price: 99  },
  { id: 'building-facilities',         name: 'Building & Facilities Management Starter Kit', price: 79 },
  { id: 'research-lab-instruments',    name: 'Research Lab Instruments Starter Kit',        price: 149 },
  { id: 'robotics-mechatronics',       name: 'Robotics & Mechatronics Starter Kit',         price: 99  },
  { id: 'oil-gas-operations',          name: 'Oil & Gas Operations Starter Kit',            price: 149 },
  { id: 'hvac-commissioning',          name: 'HVAC & Building Commissioning Starter Kit',   price: 79  },
  { id: 'aviation-mro',                name: 'Aviation Maintenance (MRO) Starter Kit',      price: 99  },
  // Agentic AI
  ...
  { id: 'ceo-founder',                 name: 'CEO & Founder Starter Kit',                   price: 99  },
  { id: 'coo-operations-leader',       name: 'COO & Operations Leader Starter Kit',         price: 79  },
  { id: 'cfo-finance-leader',          name: 'CFO & Finance Leader Starter Kit',            price: 99  },
  { id: 'cmo-marketing-leader',        name: 'CMO & Marketing Leader Starter Kit',          price: 79  },
  { id: 'chief-of-staff',              name: 'Chief of Staff Starter Kit',                  price: 79  },
  { id: 'strategy-corp-dev',           name: 'Strategy & Corporate Development Starter Kit', price: 99 },
  // HR & People Operations
  { id: 'hr-business-partner',         name: 'HR Business Partner Starter Kit',             price: 79  },
  { id: 'talent-acquisition',          name: 'Talent Acquisition & Recruiting Starter Kit', price: 79  },
  { id: 'people-operations',           name: 'People Operations Starter Kit',               price: 79  },
  { id: 'employee-relations-compliance', name: 'Employee Relations & HR Compliance Starter Kit', price: 99 },
  { id: 'compensation-benefits',       name: 'Compensation & Benefits Starter Kit',         price: 99  },
  { id: 'workforce-planning',          name: 'Workforce Planning Starter Kit',              price: 79  },
