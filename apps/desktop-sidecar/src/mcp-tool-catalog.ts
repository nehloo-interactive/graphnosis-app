...
export const MCP_TOOL_CATALOG: McpToolCatalogEntry[] = [
  ...
  { name: 'create_engram', shortDescription: 'Create a new empty engram' },
  ...
  { name: 'skill_lint', shortDescription: 'Health-check trained skills for corruption' },
  ...
  { name: 'list_quarantined', shortDescription: 'List quarantined import batches awaiting review' },
  { name: 'promote_import', shortDescription: 'Promote reviewed quarantined items into an engram' },
  { name: 'reject_import', shortDescription: 'Discard quarantined import items' },
  { name: 'get_recipient_public_key', shortDescription: 'X25519 key for receiving encrypted packs' },
  ...
  { name: 'get_engram_autonomy', shortDescription: "Read an engram's execution-autonomy dial" },
