...
const CMD: Record<string, string> = {
  ...
  brain_resolve_contradiction: 'brain:resolveContradictionPair',
  brain_compare_sources: 'brain:compareSources',
  brain_run_contradiction_scan: 'brain:runContradictionScan',
  brain_get_attention_counts: 'brain:getAttentionCounts',
  brain_get_contradiction_history: 'brain:getContradictionHistory',
